...
class SAGEConv(nn.Module):
    ...
    def forward(self, g, h):
        ...
        with g.local_scope():
            ...
            g.update_all(message_func=fn.copy_u('h', 'm'), reduce_func=fn.mean('m', 'h_N'))  # Aggregation Operation
            h_N = g.ndata['h_N']
            h_total = torch.cat([h, h_N], dim=1)   # concatenation of original and aggregated embedding

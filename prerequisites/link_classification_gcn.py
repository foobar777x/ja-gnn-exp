...
adj = sp.coo_matrix((np.ones(len(u)), (u.numpy(), v.numpy())))   # construct the sparse representation of the adjacency matrix
adj_neg = 1 - adj.todense() - np.eye(g.number_of_nodes())  # convert to dense representation and create negative adjacency matrix
...
class GraphSAGE(nn.Module):
    def __init__(self, in_feats, h_feats):
        ...
        self.conv1 = SAGEConv(in_feats, 64, 'mean')
        self.conv2 = SAGEConv(64, 32, 'mean')
        self.conv3 = SAGEConv(32, h_feats, 'mean')
